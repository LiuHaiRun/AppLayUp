...
public class CubaSortSonAdapter extends RecyclerView.Adapter {
    RankingCubaData.ContentBeanX.RoundsBean.ContentBean.DataBeanX dataBeanX;
    Context mContext;
    private int TITLE = 0;
    private int NORMAL = 1;
    private final List<RankingCubaData.ContentBeanX.RoundsBean.ContentBean.DataBeanX.DataBean> mData;

    public CubaSortSonAdapter(RankingCubaData.ContentBeanX.RoundsBean.ContentBean.DataBeanX pDataBeanX, Context pContext) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (position > 0) {
            ...
            RankingCubaData.ContentBeanX.RoundsBean.ContentBean.DataBeanX.DataBean bean = mData.get(position - 1);
