...
public class RankAdapter extends RecyclerView.Adapter<RankAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        List<RankingData.ContentBeanX.RoundsBean.ContentBean.DataBean> data = rankList.get(position).data;
        if (mFatherTab.equals("NBA")) {
            if (position == 0 || position == 6)
                setData(position, 4, holder.mRecyclerView1, data);
    ...
    private void setData(int lineNum, int rowNum, RecyclerView pRecyclerView1, List<RankingData.ContentBeanX.RoundsBean.ContentBean.DataBean> pData) {
