...
public class RankItemWestAdapter extends RecyclerView.Adapter<RankItemWestAdapter.FirstHolder> {
    ...
    public RankItemWestAdapter(Context pContext, List<RankingData.ContentBeanX.RoundsBean.ContentBean.DataBean> pData, int pFatherPostion) {
        mContext = pContext;
        data = pData;
    ...
    public void onBindViewHolder(@NonNull FirstHolder holder, int position) {
        ...
        if (TextUtils.isEmpty(data.get(position).getTeam_A_name())) {
            ...
            holder.leftTeamName.setBackgroundColor(ContextCompat.getColor(mContext, R.color.app_theme_E45040));
        }
        if (TextUtils.isEmpty(data.get(position).getTeam_B_name())) {
            ...
            holder.rightTeamName.setBackgroundColor(ContextCompat.getColor(mContext, R.color.app_theme_E45040));
        }
