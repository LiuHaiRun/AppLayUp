...
public class LeagueData {
    ...
    public static class ListBean {
         ...
         * team_A_id : 40
         * team_A_name : 上海
         * team_A_logo : https://img1.dqdgame.com/fastdfs/M00/00/74/ChOlBlvabMOARp2hAACXOQmF92U606.png
         * team_B_id : 37
         * team_B_name : 北京
         * team_B_logo : https://img1.dqdgame.com/fastdfs/M00/00/74/ChM9m1vabMGAB76EAABtd0NmZ3A779.png
         * start_play : 2019-03-19 11:35:00
         * status : Played
         * fs_A : 103
         * fs_B : 117
         * gameweek :
         ...
         * team_B_wins :
         * competition_id : 2
         * competition_name : CBA
         * round_name : CBA 季后赛首轮
         * highlight : false
         * TVList :
         * tv_source :
         * videoFlag : true
         * webLivingFlag : false
         * transfer :
         * match_title : CBA季后赛首轮
         * timestamp : 1553831285
         * playoff_fs_A :
         * playoff_fs_B :
         */
