...
import static com.jy.liuhairui.applayup.utils.NetworkUtils.isNetworkConnected;
...
public class NetInterceptor {
    ...
    public OkHttpClient getClientWithoutCache() {
        return new OkHttpClient.Builder()
                ...
                .addInterceptor(getLogInterceptor())//日志
                .addInterceptor(new CommonHeadersInterceptor())//请求头
//                .addInterceptor(new CommonParamsInterceptor())//请求参数
//                .addInterceptor(new CommonParamsPostInterceptor())
    ...
    public OkHttpClient getClientWithCache() {
        return new OkHttpClient.Builder()
                ...
                .addInterceptor(getLogInterceptor())//日志
                .addInterceptor(new CommonHeadersInterceptor())//请求头
                .addInterceptor(cacheInterceptor(Application10.getAppContext()))//缓存
