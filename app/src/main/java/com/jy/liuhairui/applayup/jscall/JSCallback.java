package com.jy.liuhairui.applayup.jscall;
...
import com.jy.liuhairui.applayup.ImageActivity;
...
//        playVideo(type, src, videoStream, refer);
        Toast.makeText(Application10.getAppContext(), "播放视频", Toast.LENGTH_SHORT).show();
    }
