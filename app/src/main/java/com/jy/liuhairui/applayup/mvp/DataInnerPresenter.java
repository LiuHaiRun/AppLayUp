...
public class DataInnerPresenter {
    ...
    public List<TempRankInfo> getRankCbaList(RankingData.ContentBeanX.RoundsBean pRoundsBean) {
        List<TempRankInfo> tempRankInfoList = new ArrayList<>();
        List<RankingData.ContentBeanX.RoundsBean.ContentBean.DataBean> data = pRoundsBean.getContent().getData();
        List<RankingData.ContentBeanX.RoundsBean.ContentBean.DataBean> nonNullData = new ArrayList<>();
        ...
        List<RankingData.ContentBeanX.RoundsBean.ContentBean.DataBean> temp1;
        //第一行
        temp1 = new ArrayList<>();
    ...
    public List<TempRankInfo> getRankList(RankingData.ContentBeanX.RoundsBean pRoundsBean) {
        List<TempRankInfo> tempRankInfoList = new ArrayList<>();
        List<RankingData.ContentBeanX.RoundsBean.ContentBean.DataBean> data = pRoundsBean.getContent().getData();
        List<RankingData.ContentBeanX.RoundsBean.ContentBean.DataBean> temp1;
