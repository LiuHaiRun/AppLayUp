...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private List<HotData.ContentsBean> classifies;
    ...
    public SuspensionDecoration(Context context, List<HotData.ContentsBean> classifies) {
        super();
    ...
    public void onDrawOver(Canvas c, final RecyclerView parent, RecyclerView.State state) {//最后调用 绘制在最上层
        ...
        String tag = classifies.get(pos).getDay();
