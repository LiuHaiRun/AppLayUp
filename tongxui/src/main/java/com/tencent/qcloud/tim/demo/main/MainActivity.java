...
public class MainActivity extends Activity implements ConversationManagerKit.MessageUnreadWatcher {
    ...
    public void tabClick(View view) {
        ...
        if (i == R.id.conversation_btn_group) {
            ...
            mConversationBtn.setTextColor(getResources().getColor(R.color.app_theme_E45040));
            mConversationBtn.setCompoundDrawablesWithIntrinsicBounds(null, getResources().getDrawable(R.drawable.tab1_img), null, null);
            mLastButton = mConversationBtn;
            ...
            mContactBtn.setTextColor(getResources().getColor(R.color.app_theme_E45040));
            mContactBtn.setCompoundDrawablesWithIntrinsicBounds(null, getResources().getDrawable(R.drawable.tab2_img), null, null);
            ...
            mProfileSelfBtn.setTextColor(getResources().getColor(R.color.app_theme_E45040));
            mProfileSelfBtn.setCompoundDrawablesWithIntrinsicBounds(null, getResources().getDrawable(R.drawable.tab3_img), null, null);
